...
export default function ContactSection() {
  return (
    <section id="contact" aria-label="Contact" className="scroll-mt-20">
      {/* Thin warm divider */}
      <div className="bg-gradient-to-b from-accent-warm/5 to-transparent h-px mb-16" />
        ...
        <div className="md:grid md:grid-cols-2 gap-12">
          ...
          <div>
            <p className="text-text-muted text-base leading-relaxed mb-8">
              I'm currently open to ITA / ITS1 roles and interesting freelance projects. Drop me a
              ...
              {SOCIAL_LINKS.map(({ label, href, icon }) => (
                <li key={label}>
                  <a
                    ...
                    className="flex items-center gap-3 text-text-muted hover:text-text transition-colors py-2"
                  >
                    {icon}
                    <span>{label}</span>
                  </a>
